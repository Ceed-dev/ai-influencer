...
- Migrated TTS from ElevenLabs (fal.ai proxy) to Fish Audio (direct REST API)
- Code changes: tts-generator.js (full rewrite), config.js (fishAudio section), orchestrator.js (referenceId param), inventory-reader.js (empty default voice)
...
- Updated all documentation, tests, and production sheet voice_id semantics
