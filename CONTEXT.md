...
### In Development (Pipeline v3.0)
- Node.js pipeline directory structure created
- Pipeline modules scaffolded (media, storage, posting, sheets)
- New sheet tabs designed (accounts, content_pipeline)
- Phase 1 MVP targeting 2/10-12
...
pipeline/                   # Node.js content pipeline (new)
  config.js                 # Environment configuration
  orchestrator.js           # Pipeline orchestration
  sheets/reader.js          # Google Sheets reader
  sheets/writer.js          # Google Sheets writer
  media/kling.js            # fal.ai Kling video generation
  media/tts.js              # fal.ai ElevenLabs TTS
  media/lipsync.js          # fal.ai Lipsync
  media/creatify.js         # Creatify video composition
  storage/drive.js          # Google Drive storage
  posting/youtube.js        # YouTube posting
  posting/instagram.js      # Instagram posting
  posting/tiktok.js         # TikTok posting
  posting/x.js              # X/Twitter posting

scripts/                    # CLI entry points
  run-pipeline.js           # Single video pipeline
  run-daily.js              # Daily batch execution
