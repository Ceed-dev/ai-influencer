...
│  fal.ai: Kling (動画生成) + Sync Lipsync (口パク) / Fish Audio (TTS)     │
...
| | Fish Audio TTS | TTS | ~$0.001/セクション × 3 × 1,080本 | **$3** | 直接REST API |
| | fal.ai Sync Lipsync Pro | 口パク同期 | $0.42/セクション × 3 × 1,080本 | **$1,361** | Pro版使用 |
| | **動画制作小計** | | | **$2,498** | Std版なら$1,947 |
...
| | Fish Audio TTS | TTS | ~$0.001 × 3 × 3,780 | **$11** | 直接REST API |
| | fal.ai Lipsync Pro | 口パク同期 | $0.42 × 3 × 3,780 | **$4,763** | |
| | **動画制作小計** | | | **$8,743** | Std: $6,816 |
...
| | Fish Audio TTS | TTS | ~$0.001 × 3 × 8,280 | **$25** | 直接REST API |
| | fal.ai Lipsync Pro | 口パク同期 | $0.42 × 3 × 8,280 | **$10,433** | |
| | **動画制作小計** | | | **$19,152** | Std: $14,929 |
...
| | Fish Audio TTS | TTS | ~$0.001 × 3 × 35,280 | **$106** | 直接REST API |
| | fal.ai Lipsync Pro | 口パク同期 | $0.42 × 3 × 35,280 | **$44,453** | → **Std版推奨** |
| | **動画制作小計(Pro)** | | | **$81,603** | |
| | **動画制作小計(Std)** | | Lipsync Std $0.25/セクション | **$63,610** | **Std版を強く推奨** |
...
| | Fish Audio TTS | TTS | ~$0.001 × 3 × 86,400 | **$259** | 直接REST API |
| | fal.ai Lipsync **Std** | 口パク同期 | $0.25 × 3 × 86,400 | **$64,800** | **Std版必須** |
| | **動画制作小計(Std)** | | | **$155,779** | Pro版だと$199,419 |
...
```
    ...
    ┌──────┴───────────────┴───────────────┴──────┐
    │              外部API層                        │
    │  fal.ai (Kling/Lipsync) + Fish Audio (TTS)    │
...
| カテゴリ | 月額 | 構成比 |
|---|---|---|
| 動画制作（fal.ai + Fish Audio） | $155,779 | **97.3%** |
| AI（OpenAI） | $820 | 0.5% |
| 投稿/分析 | $978 | 0.6% |
| インフラ | $2,475 | 1.5% |
...
| **Fish Audio TTS** | TTS費-90%（移行済み） | ElevenLabsから移行完了 |
