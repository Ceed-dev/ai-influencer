...
│  fal.ai: Kling (動画生成) + ElevenLabs (TTS) + Sync Lipsync (口パク)     │
...
| **ElevenLabs eleven-v3** (fal.ai) | TTS音声生成 | 高品質、fal.ai統合 | [$0.10/1K文字](https://fal.ai/models/fal-ai/elevenlabs/tts/eleven-v3) | ~$0.01 | [fal.ai ElevenLabs](https://fal.ai/models/fal-ai/elevenlabs/tts/eleven-v3) |
...
| | | **1動画(3セクション)合計** | | **$2.34 (Pro) / $1.83 (Std)** | [詳細](per-video-cost.md) |
...
|---|---|---|---|---|---|
| **動画制作** | fal.ai Kling | 動画生成 | $0.35/セクション × 3 × 1,080本 | **$1,134** | 5秒×3セクション |
| | fal.ai ElevenLabs | TTS | ~$0.01/セクション × 3 × 1,080本 | **$32** | |
| | fal.ai Sync Lipsync Pro | 口パク同期 | $0.42/セクション × 3 × 1,080本 | **$1,361** | Pro版使用 |
| | **動画制作小計** | | | **$2,527** | Std版なら$1,976 |
...
| カテゴリ | サービス | 用途 | 単価/根拠 | 月額コスト | 備考 |
|---|---|---|---|---|---|
| **動画制作** | fal.ai Kling | 動画生成 | $0.35 × 3 × 3,780 | **$3,969** | |
| | fal.ai ElevenLabs | TTS | ~$0.01 × 3 × 3,780 | **$113** | |
| | fal.ai Lipsync Pro | 口パク同期 | $0.42 × 3 × 3,780 | **$4,763** | |
| | **動画制作小計** | | | **$8,845** | Std: $6,918 |
...
| カテゴリ | サービス | 用途 | 単価/根拠 | 月額コスト | 備考 |
|---|---|---|---|---|---|
| **動画制作** | fal.ai Kling | 動画生成 | $0.35 × 3 × 8,280 | **$8,694** | |
| | fal.ai ElevenLabs | TTS | ~$0.01 × 3 × 8,280 | **$249** | |
| | fal.ai Lipsync Pro | 口パク同期 | $0.42 × 3 × 8,280 | **$10,433** | |
| | **動画制作小計** | | | **$19,376** | Std: $15,153 |
...
| カテゴリ | サービス | 用途 | 単価/根拠 | 月額コスト | 備考 |
|---|---|---|---|---|---|
| **動画制作** | fal.ai Kling | 動画生成 | $0.35 × 3 × 35,280 | **$37,044** | |
| | fal.ai ElevenLabs | TTS | ~$0.01 × 3 × 35,280 | **$1,058** | |
| | fal.ai Lipsync Pro | 口パク同期 | $0.42 × 3 × 35,280 | **$44,453** | → **Std版推奨** |
| | **動画制作小計(Pro)** | | | **$82,555** | |
| | **動画制作小計(Std)** | | Lipsync Std $0.25/セクション | **$64,562** | **Std版を強く推奨** |
...
| カテゴリ | サービス | 用途 | 単価/根拠 | 月額コスト | 備考 |
|---|---|---|---|---|---|
| **動画制作** | fal.ai Kling | 動画生成 | $0.35 × 3 × 86,400 | **$90,720** | |
| | fal.ai ElevenLabs | TTS | ~$0.01 × 3 × 86,400 | **$2,592** | |
| | fal.ai Lipsync **Std** | 口パク同期 | $0.25 × 3 × 86,400 | **$64,800** | **Std版必須** |
| | **動画制作小計(Std)** | | | **$158,112** | Pro版だと$201,312 |
...
```
    ...
    ┌──────┴───────────────┴───────────────┴──────┐
    │              外部API層                        │
    │  fal.ai (Kling/ElevenLabs/Lipsync)           │
...
|---|---|---|---|---|---|---|---|
| **2月** | 50 | 1,080 | $1,976 | $12 | $417 | $123 | **$2,528** |
| **3月** | 160 | 3,780 | $6,918 | $39 | $417 | $255 | **$7,629** |
| **4月** | 340 | 8,280 | $15,153 | $83 | $424 | $607 | **$16,267** |
| **5月** | 1,480 | 35,280 | $64,562 | $352 | $948 | $970 | **$66,832** |
| **6月** | 3,500 | 86,400 | $158,112 | $820 | $978 | $2,475 | **$162,385** |
| **────** | | | | | | | **────────** |
| **5ヶ月累計** | | 134,820 | $246,721 | $1,306 | $3,184 | $4,430 | **$255,641** |

### コスト構成比（6月）

| カテゴリ | 月額 | 構成比 |
|---|---|---|
| 動画制作（fal.ai） | $158,112 | **97.4%** |
| AI（OpenAI） | $820 | 0.5% |
| 投稿/分析 | $978 | 0.6% |
| インフラ | $2,475 | 1.5% |
...
| **ElevenLabs Turbo v2.5** | TTS費-50% | 音質は同等 |
...
| fal.ai ElevenLabs v3 | https://fal.ai/models/fal-ai/elevenlabs/tts/eleven-v3 |
