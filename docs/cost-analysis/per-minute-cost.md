...
| 構成 | Kling（動画生成） | ElevenLabs（TTS） | Lipsync（口パク） | **合計/分** |
|------|-------------------|--------------------|--------------------|-------------|
| **Pro Lipsync（現在）** | $4.20 | ~$0.09 | $5.00 | **$9.29/分** |
| **Standard Lipsync** | $4.20 | ~$0.09 | $3.00 | **$7.29/分** |

> ffmpeg結合はローカル処理のため無料。上記はAPI費用のみ。

### 動画長別のコスト早見表

| 動画の長さ | Pro Lipsync | Standard Lipsync |
|-----------|-------------|------------------|
| 15秒（現在のパイプライン） | $2.32 | $1.82 |
| 30秒 | $4.65 | $3.65 |
| 1分 | $9.29 | $7.29 |
| 2分 | $18.58 | $14.58 |
...
### 1-2. ElevenLabs TTS eleven-v3（音声生成）
...
※ 英語の発話速度は約150語/分、1語あたり平均6文字として約900文字/分で推定。

**公式ソース**:
- fal.ai モデルページ: https://fal.ai/models/fal-ai/elevenlabs/tts/eleven-v3
  - 記載: "Your request will cost $0.1 per 1000 character"

**ElevenLabs 直接API との比較**:
- ElevenLabs 直接: プランにより $0.12-$0.30 / 1,000文字（超過分）
- fal.ai 経由の方が安い
- ElevenLabs 料金ページ: https://elevenlabs.io/pricing/api
...
1分あたり $9.29（Pro）のうち、各サービスの占める割合:

| サービス | コスト/分 | 構成比 |
|----------|----------|--------|
| Kling（動画生成） | $4.20 | **45%** |
| Lipsync Pro（口パク） | $5.00 | **54%** |
| ElevenLabs（TTS） | ~$0.09 | **1%** |
...
|------|-------|-----|---------|-------------|------|
| **API（fal.ai Pro Lipsync）** | $4.20 | $0.09 | $5.00 | **$9.29** | 自動化可、上限なし |
| **API（fal.ai Std Lipsync）** | $4.20 | $0.09 | $3.00 | **$7.29** | 自動化可、上限なし |
...
| **ElevenLabs を Turbo v2.5 に変更** | -$0.045/分 | -$0.01/本 | 音質は同等（速度が速い） |
...
| 時期 | アカウント数 | 月間動画 | 月間動画時間 | Pro ($9.29/分) | Std ($7.29/分) |
|------|------------|---------|-------------|----------------|----------------|
| 2月 | 50 | 1,500 | 375分 | **$3,484** | **$2,734** |
| 3月 | 160 | 4,800 | 1,200分 | **$11,148** | **$8,748** |
| 4月 | 340 | 10,200 | 2,550分 | **$23,690** | **$18,590** |
| 6月 | 700 | 21,000 | 5,250分 | **$48,773** | **$38,273** |
...
| ElevenLabs eleven-v3 (fal.ai) | https://fal.ai/models/fal-ai/elevenlabs/tts/eleven-v3 |
| Kling AI 直接API料金 | https://klingai.com/global/dev/pricing |
| ElevenLabs 直接API料金 | https://elevenlabs.io/pricing/api |
