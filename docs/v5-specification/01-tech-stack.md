...
| AI-DB接続 | MCP Server (自作) | Node.js | エージェントがPostgreSQLにアクセスするインターフェース (122ツール: 103 MCPツール + 19 Dashboard REST API) |
...
| Tablet (md) | 768-1023px | 2カラム、サイドバー常時表示（折りたたみ可能） |
| Desktop (lg) | 1024-1279px | マルチカラム、サイドバー（アイコン折りたたみ切替可能） |
