...
| **レシピ推奨** | コンテンツの種別 (Hook/Body/CTA)・ジャンル・キャラクター特性に応じた最適なツール組み合わせを動的に推奨 |
...
│  │  推奨プロンプト変更:                                          │    │
│  │  ┌─────────────────────────────────────────────────────┐    │    │
│  │  │ + 「計画策定時、制作コスト見積もりの精度を過去実績から     │    │    │
│  │  │     算出すること (直近10件の実績平均 × 1.1 を上限)」     │    │    │
│  │  │ + 「コスト上限の80%を超える計画は代替案も併記すること」   │    │    │
│  │  └─────────────────────────────────────────────────────┘    │    │
│  │                                                             │    │
│  │  [プロンプト編集画面で適用 →]  [却下]  [保留]                │    │
│  └─────────────────────────────────────────────────────────────┘    │
