...
- [3. 推奨作業（実装開始後でも可）](#3-推奨作業実装開始後でも可)
  ...
  - [3.2 運用準備](#32-運用準備)
- [4. コスト概算（準備作業）](#4-コスト概算準備作業)
- [5. v4.0 → v5.0 データ移行](#5-v40--v50-データ移行)
...
|---|---------------|---------|---------|----------|
| 1 | YouTube Data API v3 | GCPプロジェクトで有効化 + OAuth同意画面設定 | 即時〜1週間 | ☑（完了: GCP有効化・OAuth同意画面設定済み、Production申請中・審査待ち） |
| 2 | TikTok Content API | TikTok Developers → アプリ作成 → 審査申請 | 2-4週間 | ☑（完了: アプリ作成・審査申請済み、In review 2026-03-06〜） |
| 3 | Instagram Graph API | Meta Developers → アプリ作成 → 審査申請 | 2-4週間 | ☑（完了: アプリ作成・Meta App Review申請済み 2026-03-10〜、審査待ち） |
