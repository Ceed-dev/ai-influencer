...
export function TikTokResultContent({ success, account_id, username, error }: Props) {
        ...
        {isSuccess ? (
          <>
            ...
            <h1 className="text-2xl font-bold text-foreground">
              {t("tiktokAuth.resultSuccess")}
            </h1>
            <p className="text-muted-foreground">
              {t("tiktokAuth.resultSuccessDetail")
