...
VALUES
  ('AUTH_ALLOWED_EMAILS', '["pochi@0xqube.xyz", "zach@0xqube.xyz", "badhan@0xqube.xyz"]'::jsonb, 'dashboard',
   'JSON array of email addresses allowed to sign in via Google OAuth',
   '[]'::jsonb, 'json'),
  ('AUTH_USER_ROLES', '{"pochi@0xqube.xyz": "admin", "zach@0xqube.xyz": "viewer", "badhan@0xqube.xyz": "viewer"}'::jsonb, 'dashboard',
